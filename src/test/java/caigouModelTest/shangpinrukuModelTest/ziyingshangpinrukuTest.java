package caigouModelTest.shangpinrukuModelTest;
...
public class ziyingshangpinrukuTest {
    ...
    public void kehuliebiaoo() throws InterruptedException {
        ...
        driver.findElement(By.xpath(".//*[@id='sub_one_3']/li[2]/a/span")).click();
        driver.findElement(By.linkText("自营商品入库")).click();
        Thread.sleep(4000);
        String title = driver.getTitle();
        Assert.assertEquals("隔壁仓库 V1.1.5 - 自营商品入库",title);
    }
