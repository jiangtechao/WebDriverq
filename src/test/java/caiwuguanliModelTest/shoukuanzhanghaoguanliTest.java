...
public class shoukuanzhanghaoguanliTest {
    ...
    public void kehuliebiaoo() throws InterruptedException {
        ...
        driver.findElement(By.xpath(".//*[@id='sub_one_4']/li[1]/a/span")).click();
        driver.findElement(By.linkText("收款账号管理")).click();
        Thread.sleep(4000);
        String title = driver.getTitle();
        Assert.assertEquals("隔壁仓库 V1.1.5 - 收款账号管理",title);
    }
