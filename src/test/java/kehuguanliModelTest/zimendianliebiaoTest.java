...
public class zimendianliebiaoTest {
    ...
    public void kehuliebiaoo() throws InterruptedException {
        ...
        driver.findElement(By.xpath(".//*[@id='sub_one_1']/li[3]/a/span")).click();
        driver.findElement(By.linkText("子门店列表")).click();
        Thread.sleep(4000);
        String title = driver.getTitle();
        Assert.assertEquals("隔壁仓库 V1.1.5 - 子门店列表",title);
    }
