...
public class ziyingzizhishenqingTest {
    ...
    public void kehuliebiaoo() throws InterruptedException {
        ...
        driver.findElement(By.xpath(".//*[@id='sub_one_2']/li[1]/a/span")).click();
        driver.findElement(By.linkText("自营商品资质申请")).click();
        Thread.sleep(4000);
        String title = driver.getTitle();
        Assert.assertEquals("隔壁仓库 V1.1.5 - 自营商品资质申请",title);
    }
