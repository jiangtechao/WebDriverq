...
public class erweimalvlixinxiTest {
    ...
    public void kehuliebiaoo() throws InterruptedException {
        ...
        driver.findElement(By.xpath(".//*[@id='sub_one_5']/li[4]/a/span")).click();
        driver.findElement(By.linkText("二维码履历")).click();
        Thread.sleep(4000);
        String title = driver.getTitle();
        Assert.assertEquals("隔壁仓库 V1.1.5 - 二维码履历信息",title);
    }
