...
public class kuaiheAppruzhushenqingTest {
    ...
    public void kehuliebiaoo() throws InterruptedException {
        ...
        driver.findElement(By.xpath(".//*[@id='sub_one_5']/li[2]/a/span")).click();
        driver.findElement(By.linkText("快喝APP入驻申请")).click();
        Thread.sleep(4000);
        String title = driver.getTitle();
        Assert.assertEquals("隔壁仓库 V1.1.5 - 详情",title);
    }
